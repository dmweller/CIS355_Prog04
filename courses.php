...
function printListing($apiCall) {
    ...
    if (!($obj->courses == null)) {
        ...
        foreach ($obj->courses as $course) {
            ...
            /*foreach($course->meetingTimes[0]->days, 0, 1 == 'M') {
                continue;
            }
            foreach($course->meetingTimes[0]->days, 0, 1 == 'T') {
                continue;
            }
            foreach($course->meetingTimes[0]->days, 0, 1 == 'W') {
                continue;
            }
            foreach($course->meetingTimes[0]->days, 0, 1 == 'R') {
                continue;
            }*/
